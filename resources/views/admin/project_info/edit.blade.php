                        ...
                        <form method="POST" action="{{ route('admin.project-info.update', $project->id) }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        <label for="lp_no" class="form-label fs-5 fw-bold text-secondary">LP
                                            Number</label>
                                    ...
                                    <div class="mb-3">
                                        <label for="rera_no" class="form-label fs-5 fw-bold text-secondary">RERA
                                            Number</label>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="location"
                                            class="form-label fs-5 fw-bold text-secondary">Location</label>
                                        <input type="text" name="location" id="location" class="form-control" required
                                            value="{{$project->location}}" placeholder="Enter Location">
                                    </div>

                                    <div class="mb-3">
                                        <label for="survey_no" class="form-label fs-5 fw-bold text-secondary">Survey
                                            No</label>
                                        <input type="number" name="survey_no" id="survey_no" class="form-control"
                                            required value="{{$project->survey_no}}" placeholder="Enter Survey No">
                                    </div>

                                    <div class="mb-3">
                                        <label for="extent" class="form-label fs-5 fw-bold text-secondary">Extent
                                            (Acres)</label>
                                        <input type="number" name="extent" id="extent" class="form-control" required
                                            value="{{$project->extent}}" placeholder="Enter Extent (Acres)" step="0.1">
                                    </div>
                                </div>
                            </div>
