                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.customer-details.update', $customer->id) }}"
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="customer_name" id="customer_name" class="form-control"
                                        required value="{{old('customer_name', $customer->customer_name)}}"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" name="phone_number" id="phone_number" class="form-control"
                                        required value="{{old('phone_number', $customer->phone_number)}}"
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="pan_no" class="form-label fs-5 fw-bold text-secondary">PAN NO</label>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="address" class="form-label fs-5 fw-bold text-secondary">Address</label>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="total_plot_value" class="form-label fs-5 fw-bold text-secondary">Total
                                        Plot Value</label>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="status" id="status" class="form-select" required>
                                        <option value="Booked" {{ $customer->status == 'Booked' ? 'selected' : '' }}>
                                            Booked</option>
                                        <option value="Registered" {{ $customer->status == 'Registered' ? 'selected' : '' }}>Registered</option>
                                    </select>
                                </div>
                            </div>
