                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST"
                            ...
                            <div class="mb-3">
                                <label for="payment_date" class="form-label fs-5 fw-bold text-secondary">Date
                                </label>

                                <input type="date" name="payment_date" id="payment_date" class="form-control" required
                                    value="{{old('payment_date')}}" placeholder="Enter Bank Name">
                            </div>
                            ...
                            <div class="mb-3">
                                <label for="mode_of_payment" class="form-label fs-5 fw-bold text-secondary">Mode Of
                                    Payment
                                </label>
                            ...
                            <div class="mb-3">
                                <label for="bank_name" class="form-label fs-5 fw-bold text-secondary">Remarks
                                </label>
