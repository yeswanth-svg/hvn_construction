                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="total_plots" id="total_plots" class="form-control"
                                            required value="{{$plot->total_plots}}" placeholder="Enter Total Plots">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="mortgaged_plots" id="mortgaged_plots"
                                            class="form-control" required value="{{$plot->mortgaged_plots}}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="developer_plots" id="developer_plots"
                                            class="form-control" required value="{{$plot->developer_plots}}"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="land_owner_plots" id="land_owner_plots"
                                            class="form-control" readonly value="{{ $plot->land_owner_plots}}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="registered_plots" id="registered_plots"
                                            class="form-control" required value="{{ $plot->registered_plots}}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="booked_plots" id="booked_plots" class="form-control"
                                            required value="{{$plot->booked_plots}}" placeholder="Enter Booked Plots">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="available_plots" id="available_plots"
                                            class="form-control" readonly value="{{$plot->available_plots}}"
