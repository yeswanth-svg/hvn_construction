                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.each-plot-information.store') }}"
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="ownership" id="ownership" class="form-select" required>
                                        ...
                                        <option value="Land Owner" {{ old('ownership') == 'Land Owner' ? 'selected' : '' }}>Land Owner</option>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="geo_coordinates_n" id="geo_coordinates_n"
                                        class="form-control" required value="{{ old('geo_coordinates_n') }}"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="geo_coordinates_e" id="geo_coordinates_e"
                                        class="form-control" required value="{{ old('geo_coordinates_e') }}"
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="plot_area_sq_yds" class="form-label fs-5 fw-bold text-secondary">Plot
                                        Area (sq. yds)</label>
                                    <input type="number" name="plot_area_sq_yds" id="plot_area_sq_yds"
                                        class="form-control" required value="{{ old('plot_area_sq_yds') }}"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" name="plot_area_cents" id="plot_area_cents"
                                        class="form-control" required value="{{ old('plot_area_cents') }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="plot_availability_for_sale" id="plot_availability_for_sale"
                                        ...
                                        <option value="no" {{ old('plot_availability_for_sale') == 'no' ? 'selected' : '' }}>No</option>
